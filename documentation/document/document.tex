...
Zoals al eerder vermeld, is voor de rest van het elektronisch netwerk een microfoon gelijk aan een spanningsbron. Stel dat we in serie met die spanningsbron twee weerstanden schakelt (figuur \ref{fig:volume}), dan hebben we een zogenaamde \textbf{spanningsdeler} gebouwd. We gaan aantonen de spanning $V_2$ een verkleinde versie is van het muzieksignaal $V_s$.
...
De stroom in heel het circuit is dezelfde ($I_s = I_1 = I_2$). We kunnen die stroom berekenen door twee weerstanden de vervangen door hun serie-weerstand, 
