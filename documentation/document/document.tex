...
\begin{document}
	...
	\label{sec:bouwstenen}
		...
		\subsection{De magische zwarte doos: IC's}
	...
	\section{Knutselen: bouwen van de behuizing en de PCB}
		In figuur \ref{fig:volledig_schema} zie je het volledig elektronisch schema van de versterker. 
		\begin{figure}[htbp]
			%\centering
		...
		\end{figure}
		Enkele componenten zijn bijgevoegd: $C_1$, $C_2$ en $C_5$. $C_1$ en $C_2$ dienen om DC signalen te blokkeren, dit kan omdat capaciteiten alleen reageren op veranderingen van spanning. $C_5$ is er om de batterij te helpen stroom te leveren, omdat een capaciteit ook kan worden opgeladen om daarna stroom te leveren, net zoals een kleine batterij.

		Als snelle referentie vind je hier de componentwaarden die nodig zijn om een werkende versterker te hebben.
